    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        for piece in splits:
            ...
            if len(piece) <= self.chunk_size:
                ...
                deeper = self._split(piece, next_seps)
                sub_chunks.extend(deeper)
        ...
        for piece in sub_chunks:
            if not current_merged:
                ...
                candidate = current_merged + sep + piece
...
class ChunkingStrategyComparator:
    ...
    def compare(self, text: str, chunk_size: int = 200) -> dict:
        fixed_chunks = FixedSizeChunker(chunk_size=chunk_size, overlap=min(50, chunk_size // 2)).chunk(text)
